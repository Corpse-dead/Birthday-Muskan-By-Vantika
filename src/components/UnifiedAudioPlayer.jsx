  ...
  return (
    <>
      ...
      <audio
        ...
        style={{ display: 'none' }}
      >
        <source src="/Maana_Ke_Hum_Yaar_Nahin_Full_Song_Meri_Pyaari_Bindu_Parineeti_Chopra.mp3" type="audio/mpeg" />
        <source src="./Maana_Ke_Hum_Yaar_Nahin_Full_Song_Meri_Pyaari_Bindu_Parineeti_Chopra.mp3" type="audio/mpeg" />
      ...
      <motion.div
        ...
        className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-[9999]"
      >
        <motion.button
          ...
          className={`
            ...
            ${!hasUserInteracted 
              ...
              : isPlaying 
                ? 'bg-gradient-to-r from-pink-400/90 to-pink-600/90 border-pink-300 text-white hover:from-pink-500/90 hover:to-pink-700/90'
                : 'bg-gradient-to-r from-pink-500/90 to-pink-700/90 border-pink-300 text-white hover:from-pink-600/90 hover:to-pink-800/90'
            }
            ...
            >
              <div className="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-3 py-2 sm:px-4 sm:py-3 rounded-lg shadow-lg text-center">
                <div className="text-xs sm:text-sm font-love">
                  💕 Surprise! Your special song is playing...
                </div>
      ...
      <AnimatePresence>
        {isPlaying && (
          ...
          >
            <div className="bg-white-cream/90 backdrop-blur-sm rounded-full px-3 py-2 sm:px-4 sm:py-2 border border-pink-candy shadow-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="font-love text-pink-hot text-xs sm:text-sm">
                  <span className="hidden sm:inline">Playing for Muskan</span>
      ...
      <AnimatePresence>
        {isPlaying && (
          ...
          >
            <div className="flex items-end space-x-1 bg-white-cream/20 backdrop-blur-sm rounded-lg p-2 border border-pink-soft/30">
              {[...Array(5)].map((_, i) => (
                <motion.div
                  key={i}
                  animate={{
                  ...
                  className="w-1.5 h-6 bg-gradient-to-t from-pink-medium via-pink-hot to-pink-candy rounded-full"
